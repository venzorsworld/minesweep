...
STATUS_ICONS = {
    ...
    STATUS_PLAYING: "./images/sword.png",
    STATUS_FAILED: "./images/cross.png",
    STATUS_SUCCESS: "./images/sword.png",
}
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.button.setIcon(QIcon("./images/sword.png"))
    ...
    def reset_map(self):
        ...
        while len(positions) < self.n_mines:
            x, y = random.randint(0, self.b_size - 1), random.randint(1, self.b_size - 1)
